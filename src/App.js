    ...
    <div className="app">
      ...
      {selectedFriend && (
        <FormSplitBill
          ...
          key={selectedFriend.id} // This key prop is really helpful to reset states!!!!
        />
      )}
    </div>
  );
...
function FormSplitBill({ selectedFriend, onSplitBill }) {
  ...
  function handleSubmit(e) {
    ...
    onSplitBill(whoIsPaying === "user" ? friendExpense : -selfExpense);
  }
  ...
  return (
    <form className="form-split-bill" onSubmit={handleSubmit}>
      ...
      <input
        ...
        onChange={(e) =>
          setSelfExpense(
            Number(e.target.value) > bill ? selfExpense : Number(e.target.value)
          )
        }
      />
